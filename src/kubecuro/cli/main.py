...
# Command Modules
from kubecuro.cli.commands.base import (
    get_console, 
    print_custom_header, 
    print_version, 
    get_console, 
...
from kubecuro.cli.commands.scan import handle_scan_command
from kubecuro.cli.commands.heal import handle_heal_command
from kubecuro.cli.commands.catalog import handle_catalog_command

# Global setup
console = get_console()
formatter = AkesoFormatter()
logger = logging.getLogger("kubecuro.cli")
...
def main():
    ...
    from kubecuro.cli.commands.base import normalize_paths
    ...
    # Init Dispatch
    if args.command == "init":
        from kubecuro.cli.commands.config import handle_init_command
        sys.exit(handle_init_command(console))

    # Explain Dispatch
    if args.command == "explain":
        from kubecuro.cli.commands.explain import handle_explain_command
        sys.exit(handle_explain_command(args, console))

    # Completion Dispatch
    if args.command == "completion":
        from kubecuro.cli.commands.completion import handle_completion_command
    ...
    if args.command == "auth":
        from kubecuro.cli.commands.auth import handle_auth_command
