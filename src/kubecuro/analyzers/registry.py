"""
AKESO ANALYZER REGISTRY
-----------------------
This module implements the Registry pattern for managing Akeso Analyzers.
...
from kubecuro.analyzers.base import BaseAnalyzer

logger = logging.getLogger("kubecuro.analyzers.registry")
...
class AnalyzerRegistry:
    ...
    def register_defaults(cls):
        ...
        try:
            from kubecuro.analyzers.cross_resource import CrossResourceAnalyzer
            from kubecuro.analyzers.best_practices import (
                ResourceAnalyzer, 
                ImageAnalyzer, 
                SecurityAnalyzer, 
                ProbeAnalyzer
